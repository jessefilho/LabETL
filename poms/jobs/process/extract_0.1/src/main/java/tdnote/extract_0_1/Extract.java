...
/**
 * Job: Extract Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class Extract implements TalendJob {
	...
	private final String jobName = "Extract";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Extract.this, new Object[] { e,
	...
	public static class out6Struct implements
		...
		final static byte[] commonByteArrayLock_TDNOTE_Extract = new byte[0];
		static byte[] commonByteArray_TDNOTE_Extract = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TDNOTE_Extract.length) {
					if (length < 1024
							&& commonByteArray_TDNOTE_Extract.length == 0) {
						commonByteArray_TDNOTE_Extract = new byte[1024];
					} else {
						commonByteArray_TDNOTE_Extract = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TDNOTE_Extract, 0, length);
				strReturn = new String(commonByteArray_TDNOTE_Extract, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TDNOTE_Extract) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_6 == null
					...
					tableName_tDBOutput_6 = "StageContrats";
				} else {
				...
				try (java.sql.Statement isExistStmt_tDBOutput_6 = conn_tDBOutput_6
						.createStatement()) {
					try {
						isExistStmt_tDBOutput_6.execute("SELECT TOP 1 1 FROM ["
					...
					try (java.sql.Statement stmtCreate_tDBOutput_6 = conn_tDBOutput_6
						...
						stmtCreate_tDBOutput_6
								.execute("CREATE TABLE ["
										+ tableName_tDBOutput_6
										+ "]([Contrat] VARCHAR(50)  ,[Annee_debut] INT ,[Annee_fin] INT )");
					}
				}
				String insert_tDBOutput_6 = "INSERT INTO ["
						+ tableName_tDBOutput_6
						+ "] ([Contrat],[Annee_debut],[Annee_fin]) VALUES (?,?,?)";
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/AkIn/Desktop/TDnote/contrats.txt";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/AkIn/Desktop/TDnote/contrats.txt",
								"US-ASCII", ",", "\n", false, 1, 0, -1, -1,
								false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row6.Contrat = fid_tFileInputDelimited_1
						...
						if (row6 != null) {
							...
							{ // start of Var scope
								...
								// # Output table : 'out6'
								out6_tmp.Contrat = row6.Contrat;
								out6_tmp.Annee_debut = row6.Annee_debut;
								out6_tmp.Annee_fin = row6.Annee_fin;
								out6 = out6_tmp;
								// ###############################
							...
							if (out6 != null) {
								...
								if (out6.Contrat == null) {
									pstmt_tDBOutput_6.setNull(1,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_6
											.setString(1, out6.Contrat);
								}

								if (out6.Annee_debut == null) {
								...
								if (out6.Annee_fin == null) {
									pstmt_tDBOutput_6.setNull(3,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_6.setInt(3, out6.Annee_fin);
								}
					...
					if (!((Object) ("C:/Users/AkIn/Desktop/TDnote/contrats.txt") instanceof java.io.InputStream)) {
	...
	public static void main(String[] args) {
		final Extract ExtractClass = new Extract();

		int exitCode = ExtractClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Extract.class.getClassLoader()
					.getResourceAsStream(
							"tdnote/extract_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = Extract.class.getClassLoader().getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Extract");
		}
...
/************************************************************************************************
 * 52778 characters generated by Talend Open Studio for Data Integration on the
 * November 14, 2018 5:25:59 PM CET
 ************************************************************************************************/
