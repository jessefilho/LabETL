...
package tdnote.loaddimclasse_0_1;
...
/**
 * Job: LoadDimClasse Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class LoadDimClasse implements TalendJob {
	...
	private final String jobName = "LoadDimClasse";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					LoadDimClasse.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(LoadDimClasse.this, new Object[] { e,
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_TDNOTE_LoadDimClasse = new byte[0];
		static byte[] commonByteArray_TDNOTE_LoadDimClasse = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TDNOTE_LoadDimClasse.length) {
					if (length < 1024
							&& commonByteArray_TDNOTE_LoadDimClasse.length == 0) {
						commonByteArray_TDNOTE_LoadDimClasse = new byte[1024];
					} else {
						commonByteArray_TDNOTE_LoadDimClasse = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TDNOTE_LoadDimClasse, 0, length);
				strReturn = new String(commonByteArray_TDNOTE_LoadDimClasse, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TDNOTE_LoadDimClasse) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "tp5_dw_classe";
				} else {
				...
				String insert_tDBOutput_1 = "INSERT INTO ["
						+ tableName_tDBOutput_1 + "] ([classe]) VALUES (?)";
				...
				String dbquery_tDBInput_1 = "select classe from StageInscrits group by classe";
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
									...
									row1.classe = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.classe = tmpContent_tDBInput_1;
								}
							} else {
								row1.classe = null;
							}
						...
						if (out1 != null) {
							...
							if (out1.classe == null) {
								...
								pstmt_tDBOutput_1.setString(1, out1.classe);
							}
	...
	public static void main(String[] args) {
		final LoadDimClasse LoadDimClasseClass = new LoadDimClasse();

		int exitCode = LoadDimClasseClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LoadDimClasse.class
					.getClassLoader().getResourceAsStream(
							"tdnote/loaddimclasse_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = LoadDimClasse.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : LoadDimClasse");
		}
...
/************************************************************************************************
 * 47826 characters generated by Talend Open Studio for Data Integration on the
 * November 13, 2018 4:31:52 PM CET
 ************************************************************************************************/
